...
const sharedZhuRunner = "scripts/run_review_bundle_test.py";
const shangyuSkill = "skills/shangyu-review-loop.md";
const shangyuRunner = "scripts/run_shangyu_loop_prompt.py";
...
const steps = {
  "pair-zhu": node(
    ...
    ["skills/zhu-response-pairing.md", "scripts/run_zhu_pairing.py"]
  ),
  "pair-yu": node(
    ...
    ["skills/yu-response-pairing.md", "scripts/run_yu_pairing.py"]
  ),
  "pair-yu-source": node(
    ...
    [shangyuSkill, shangyuRunner, "skills/trace-source-chain.md"]
  ),
  "summary": node(
    ...
    ["skills/quick-summary.md", "scripts/summarize_stage1_shangzou_vertex.py", sharedZhuRunner]
  ),
  "divide": node(
    ...
    ["skills/divide-into-parts.md", sharedZhuRunner]
  ),
  "human-read": node(
    ...
    ["skills/quick-summary.md", "skills/divide-into-parts.md", sharedZhuRunner]
  ),
  "zhu-select": node(
    ...
    ["skills/zhu-review-loop.md", "scripts/run_zhu_review_loop.py", sharedZhuRunner]
  ),
  "zhu-lin": node(
    ...
    ["skills/extract-lin-actions.md", sharedZhuRunner]
  ),
  "zhu-qing-done": node(
    ...
    ["skills/extract-qing-actions-done.md", sharedZhuRunner]
  ),
  "zhu-qing-plan": node(
    ...
    ["skills/extract-qing-actions-planned.md", sharedZhuRunner]
  ),
  "zhu-source": node(
    ...
    ["skills/trace-source-chain.md", sharedZhuRunner]
  ),
  "zhu-emperor": node(
    ...
    ["skills/extract-zhupi.md", sharedZhuRunner]
  ),
  "zhu-yu-reply": node(
    ...
    ["skills/edict-match.md", "skills/extract-emperor-action.md", sharedZhuRunner]
  ),
  ...
  "json-output": node(
    ...
    ["skills/zhu-review-loop.md", shangyuSkill, "scripts/run_zhu_review_loop.py", shangyuRunner, sharedZhuRunner]
  ),
  "review-card": node(
    ...
    ["skills/extract-emperor-action.md", "skills/official-response.md", sharedZhuRunner]
  ),
  "human-adopt": node(
    ...
    ["skills/official-response.md", "skills/yu-response-pairing.md", "scripts/merge_pairs.py"]
  ),
};
...
function chatBindingFor(path) {
  ...
  if (path.startsWith("scripts/")) return currentLanguage === "zh" ? {
