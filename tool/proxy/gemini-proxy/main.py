    ...
    try:
        ...
        if mode == "combined_emperor_actions":
            ...
            task = (
                ...
                "每項另填 origin_doc_id、origin_type，指出這項皇帝行動實際源自哪一份主要皇帝文書：源自上諭就填該上諭與上諭，源自硃批就填該硃批與硃批；若硃批與上諭合併為同一行動，選承載主要實質皇帝原話的來源，不得按最早日期選擇；origin_doc_id 必須來自上列可用文書，奏摺只能是輔助來源，不得作為 origin。"
                ...
                '"whenCh":"","whenAr":"","where":"","who":[],"who_loc":{},"relations":[],"origin_doc_id":"","origin_type":"上諭|硃批","same_as_event_id":"",'
