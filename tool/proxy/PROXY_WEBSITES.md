...
Each command includes its required working directory. The deploy scripts build
the code in that proxy directory and print the resulting Cloud Run URL.

```bash
cd "/Users/creamybanana/Downloads/DH Project/tool/proxy/gemini-proxy"
bash deploy.sh

cd "/Users/creamybanana/Downloads/DH Project/tool/proxy/chatgpt-proxy"
export TOKENROUTER_API_KEY='your-tokenrouter-key'
bash deploy.sh

cd "/Users/creamybanana/Downloads/DH Project/tool/proxy/deepseek-proxy"
bash deploy.sh

cd "/Users/creamybanana/Downloads/DH Project/tool/proxy/glm-proxy"
