...
Examples:
  ...
  python3 "tool/scripts py/run_zhu_pairing.py" --doc-id 台46 --dry-run
  # every official doc sent in a month, against the proxy:
  python3 "tool/scripts py/run_zhu_pairing.py" --proxy https://... --reverse-month 1787/03 --skip-done
  # whole corpus:
  python3 "tool/scripts py/run_zhu_pairing.py" --proxy https://... --all
"""
...
PROMPT_PATH = ROOT / "tool" / "skills md" / "zhu-response-pairing.md"
