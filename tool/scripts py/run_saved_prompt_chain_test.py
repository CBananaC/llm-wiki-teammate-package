...
result before scaling up:
    ...
    GEMINI_PROXY_URL=https://... \
        python3 "tool/scripts py/run_saved_prompt_chain_test.py"
...
Every prompt text comes from llm-wiki/tool/skills md/*.md via skill_prompt(), so this
...
# dates are ["中曆", "YYYY/M/D"] pairs -- see stage1_original_text.json)
# ---------------------------------------------------------------------------
