#!/usr/bin/env python3
"""Export confirmed 上諭／硃批 response pairs to shareable JSON.

Non-destructive alternative to merge_pairs.py: instead of writing into the
source corpus (stage1_original_text.json), this reads the pairs you marked
...
Usage:
  python3 "tool/scripts py/export_pairs.py"            # write confirmed-pairs.json + bundle
  python3 "tool/scripts py/export_pairs.py" --dry-run  # report only
"""
